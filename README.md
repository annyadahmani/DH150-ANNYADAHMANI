...
> My initial overall evaluation about this webpage was how busy and chaotic it looked. There is just too much happening and it's overwhelming. I also notice random pictures and text floating on the page and a lot of white space on the right side of the page. At first glance, it seemed like there was no uniformity within the page. Another initial observation I had was the color coding of the left categorical index. The color coding seemed off where there were light brown, dark brown, orange, and green colored fonts. I was unsure whether text on the page was supposed to function as normal text or if the text was meant to be clicked on and function as a button to take a user to another page. 
...
![app homepage](apphome-screenshot.PNG)
...
### Conclusion
> In conclusion, after taking into account the description, initial evaluation, and heurisitics evaluation, it is evident that both Joy of Baking and Cake and Baking Recipes For You, have usability and comsetic issues that should be addressed so that the mid-aged woman can find true happiness while using this specific web and app. Addressing the major usability and cosmetic concerns for Joy of Baking, I suggest that the most important things to fix right away are working to fix the inability to search more than the first initial search, working to fix the design and make it more minimalistic and aesthetic, working to make buttons and things that should be clicked look like they are meant to be clicked, and working to make the top and side categories both look and work more efficiently. Addressing the major usabilitty and cosmetic concerns for Cake and Baking For You, I suggest that the most important things to fix right away are working to add a help/contact/FAQ section, working to make errors more understandable, working to make the design more simplistic, and working to fix the glitch when I trying to share a recipe and the app freezes so users are forced to quit the app.
